...
LOCAL_DAG_FOLDER="$LOCAL_PROJECT_FOLDER/airflow/Tweets/*"

REMOTE_PROJECT_FOLDER="/home/pi/test"
REMOTE_RESOURCE_FOLDER="$REMOTE_PROJECT_FOLDER/resources"
MASTER_SSH_PROJECT="${MASTER_SSH}:$REMOTE_PROJECT_FOLDER"
SLAVE1_SSH_PROJECT="${SLAVE1_SSH}:$REMOTE_RESOURCE_FOLDER"
SLAVE2_SSH_PROJECT="${SLAVE2_SSH}:$REMOTE_RESOURCE_FOLDER"

ssh $SLAVE1_SSH mkdir "test"
RESOURCES_SCP_SLAVE1_CMD="scp -r $LOCAL_PROJECT_FOLDER/resources/ $SLAVE1_SSH_PROJECT"
eval "$RESOURCES_SCP_SLAVE1_CMD"

ssh $SLAVE2_SSH mkdir "test"
